...
- The repository now has dedicated root scripts for Mac Catalyst development and release validation:
...
- The active runbooks are `docs/mobile/macos-dev.md` and `docs/mobile/macos-app-store-submission.md`.
...
4. Validate submission details through `docs/mobile/macos-app-store-submission.md`.
...
Status: historical. The repository now has local Mac Catalyst build scripts; use `npm run mobile:dev:macos` or `npm run mobile:build:macos`.
