...
// shouldTraceRequest set: all HERMES_BRIDGE_RETRY_METHODS plus 'connect'.
// Exported so the subset invariant (HERMES_BRIDGE_RETRY_METHODS ⊆ HERMES_BRIDGE_TRACED_METHODS)
// can be asserted in tests without private-class casts.
...
export class GatewayClient {
  ...
  private isHermesRelayBridgeRetryEligible(method: string): boolean {
    return this.getBackendKind() === 'hermes'
      ...
      && HERMES_BRIDGE_RETRY_METHODS.has(method);
  }
